...
ARG GCS_BUCKET_NAME="avatarai"
ARG GCS_BUCKET_NAME=${GCS_BUCKET_NAME}
ARG GCS_PROJECT_ID="avatar-68350"
ENV GCS_PROJECT_ID=${GCS_PROJECT_ID}
ARG GCS_FINETUNED_MODEL_PATH="axolotl-fine-tuning-custom"
ENV GCS_FINETUNED_MODEL_PATH=${GCS_FINETUNED_MODEL_PATH}
